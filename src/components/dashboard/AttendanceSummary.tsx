...
import { CheckCircle2, ChevronRight, CalendarCheck2 } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 id="attendance-title" className="text-[10px] font-black uppercase tracking-[0.3em] text-white">
              Attendance
            </h2>
          </div>
